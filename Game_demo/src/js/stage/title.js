...
class TitleScreen extends Stage {
    ...
    onResetEvent() {
        ...
        var title = new ButtonEntity(600, 300, "Jump_Lite", 0);
        var button_new_game = new ButtonEntity(650, 480, "New_Game", 1 );
        var button_load_game = new ButtonEntity(645, 580, "Load_Game", 2);
        var button_leaderboard = new ButtonEntity(640, 680, "Leaderboard", 3);
